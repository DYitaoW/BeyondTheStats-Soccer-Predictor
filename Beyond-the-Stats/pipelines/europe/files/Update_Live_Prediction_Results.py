...
GLOBAL_PREDICTIONS_FILE = str(_bts_paths.GLOBAL_UPCOMING_FILE)
MLS_PREDICTIONS_FILE = str(_bts_paths.MLS_UPCOMING_FILE)
EXTRA_PREDICTIONS_FILE = str(_bts_paths.EXTRA_UPCOMING_FILE)
CUP_PREDICTIONS_FILE = str(_bts_paths.CUP_UPCOMING_FILE)
NATIONAL_PREDICTIONS_FILE = str(_bts_paths.NATIONAL_UPCOMING_FILE)
FRIENDLIES_PREDICTIONS_FILE = str(_bts_paths.FRIENDLIES_UPCOMING_FILE)
