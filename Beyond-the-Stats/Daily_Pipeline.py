"""Compatibility shim — real module lives in ``main/Daily_Pipeline.py``.

- As a script: forwards to ``main/Daily_Pipeline.py``.
- As an import: loads ``main/Daily_Pipeline.py`` and re-exports its public attrs
