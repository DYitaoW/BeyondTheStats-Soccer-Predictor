...
class FutureGamesWatcher:
    ...
    DEFAULT_PATHS = (
        "Beyond-the-Stats/Output/Predictions/europe/upcoming_matchweek_predictions.csv",
        "Beyond-the-Stats/Output/Predictions/cups/upcoming_cup_predictions.csv",
        "Beyond-the-Stats/Output/Predictions/national/upcoming_national_team_predictions.csv",
        "Beyond-the-Stats/Output/Predictions/mls/upcoming_matchweek_predictions.csv",
        "Beyond-the-Stats/Output/Predictions/extra/upcoming_matchweek_predictions.csv",
    )
