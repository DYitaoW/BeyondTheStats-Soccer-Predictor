...
if str(_paths.SHARED_DIR) not in sys.path:
    sys.path.insert(0, str(_paths.SHARED_DIR))
import team_mapping_groups as tmg  # noqa: E402

RAW_DIRS = [
    str(_paths.DATA_DIR / "Raw_Data"),
    str(_paths.MLS_DATA_DIR / "Raw_Data"),
    str(_paths.EXTRA_DATA_DIR / "Raw_Data"),
]

UPCOMING_FILES = [
    str(_paths.GLOBAL_UPCOMING_FILE),
    str(_paths.CUP_UPCOMING_FILE),
    str(_paths.NATIONAL_UPCOMING_FILE),
    str(_paths.FRIENDLIES_UPCOMING_FILE),
    str(_paths.MLS_UPCOMING_FILE),
    str(_paths.EXTRA_UPCOMING_FILE),
    str(_paths.ALL_UPCOMING_FILE),
]
