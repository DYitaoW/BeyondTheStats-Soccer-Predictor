...
PROJECT_DIR = os.path.dirname(SCRIPTS_DIR)  # Beyond-the-Stats/
import sys
if PROJECT_DIR not in sys.path:
    sys.path.insert(0, PROJECT_DIR)
from shared import paths as _paths
MAPPING_FILE = str(_paths.TEAM_NAME_MAPPING_MASTER)
...
COMP_TO_DIRS = {
    ...
    "Belgium/First Division A":   ["Data/Raw_Data/Belgium/First Division A",
                                   "pipelines/extra/Data/Raw_Data/Belgium/First Division A"],
    ...
    "Greece/Super League":        ["Data/Raw_Data/Greece/Super League",
                                   "pipelines/extra/Data/Raw_Data/Greece/Super League"],
    "Norway/Eliteserien":         ["Data/Raw_Data/Norway/Eliteserien",
                                   "pipelines/extra/Data/Raw_Data/Norway/Eliteserien"],
    "Poland/Ekstraklasa":         ["Data/Raw_Data/Poland/Ekstraklasa",
                                   "pipelines/extra/Data/Raw_Data/Poland/Ekstraklasa"],
    "Romania/Liga I":             ["Data/Raw_Data/Romania/Liga I",
                                   "pipelines/extra/Data/Raw_Data/Romania/Liga I"],
    "Sweden/Allsvenskan":         ["Data/Raw_Data/Sweden/Allsvenskan",
                                   "pipelines/extra/Data/Raw_Data/Sweden/Allsvenskan"],
    "Austria/Bundesliga":         ["Data/Raw_Data/Austria/Bundesliga",
                                   "pipelines/extra/Data/Raw_Data/Austria/Bundesliga"],
    "United States/MLS":          ["pipelines/mls/Data/Raw_Data/United States/MLS"],
    "Mexico/Liga MX":             ["pipelines/mls/Data/Raw_Data/Mexico/Liga MX",
                                   "pipelines/extra/Data/Raw_Data/Mexico/Liga MX"],
    "Argentina/Primera Division": ["pipelines/extra/Data/Raw_Data/Argentina/Primera Division"],
    "Brazil/Brasileirão":            ["pipelines/extra/Data/Raw_Data/Brazil/Brasileirão"],
    "Japan/J1 League":           ["pipelines/extra/Data/Raw_Data/Japan/J1 League"],
}
