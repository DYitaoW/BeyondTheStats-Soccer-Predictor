...
Raw trees cleared (by default all three):
  ...
  Data/Raw_Data/
  pipelines/mls/Data/Raw_Data/
  pipelines/extra/Data/Raw_Data/
...
RAW_DATA_BY_PIPELINE = {
    "global": _paths.DATA_DIR / "Raw_Data",
    "mls": _paths.MLS_DATA_DIR / "Raw_Data",
    "extra": _paths.EXTRA_DATA_DIR / "Raw_Data",
}
