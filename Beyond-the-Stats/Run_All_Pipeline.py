"""Compatibility shim — real module lives in ``main/Run_All_Pipeline.py``.

- As a script: forwards to ``main/Run_All_Pipeline.py``.
- As an import: loads ``main/Run_All_Pipeline.py`` and re-exports its public attrs
